...
<html id="kontakt" lang="de">
   <head>
      <meta charset="utf-8">
      <title>D.A. Film - PE Beutel und Hauben - anfrage</title>
   ...
   <body>
      ...
      <header>
         <div class="header-box">
            <h1>PE Beutel und Hauben - anfrage</h1>
            <div class="text-box">
               <p>
            ...
            <?php
               ...
               if ($action=="")
                   ...
                   <select class="product-select" name="nazwa-produktu">
                      <option value="">---</option>
                      <option value="worki śmieciowe">Müllsäcke</option>
                      <option value="worki azbest UE niebieskie">Asbest EU Standard – blau gedruckte Säcke</option>
                      <option value="worki azbest UE bezbarwne druk">Asbest EU Standard - farblos gedruckt</option>
                      <option value="worki azbest UE bezbarwne">Asbest EU Standard – farblose</option>
                      <option value="worki azbest UK">Asbest UK Standard – farblos und rot gedruckt</option>
                      <option value="kaptur termokurczliwy">Schrumpfhauben</option>
                   </select>
