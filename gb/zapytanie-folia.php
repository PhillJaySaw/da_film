...
<html id="kontakt" lang="en">
   <head>
      <meta charset="utf-8">
      <title>D.A. Film - PE films- ask about the product</title>
   ...
   <body>
      ...
      <header>
         <div class="header-box">
            <h1>PE films- ask about the product</h1>
            <div class="text-box">
               <p>
            ...
            <?php
               ...
               if ($action=="")
                   ...
                   <select class="product-select" name="nazwa-produktu">
                      <option value="">---</option>
                      <option value="Folie budowlane">Construction film</option>
                   ...
                   <h3>Dimensions</h3>
                     ...
                     <select class="product-select" name="ilosc">
                        <option value="">---</option>
                        <option value="metry kwadratowe">square meters</option>
                        <option value="w rolce">on the roll</option>
                     </select>
                     <input type="text" name="ilosc-liczba" value="" placeholder="amount">
                     ...
                     <input type="text" name="ilosc-box" value="" placeholder="quantity on the pallete">
