            ...
            <?php
               ...
               if ($action=="")
                   ...
                   <h3>Dimensionen:</h3>
                     ...
                     <label for="iloscRolka">Menge auf der Rolle</label>
                     <input type="text" name="iloscNaRolce" value="" placeholder="sztuki"> * gilt nur für <b>Bogen und Lochblätter auf Rollen</b>
