...
<html id="kontakt" lang="de">
   <head>
      <meta charset="utf-8">
      <title>D.A. Film - PE Film - anfrage</title>
   ...
   <body>
      ...
      <header>
         <div class="header-box">
            <h1>PE Film - anfrage</h1>
            <div class="text-box">
               <p>
                  Wenn Sie Fragen zu einem bestimmten Produkt haben, oder uns Dimensionen
                  des Produkts in dem Sie interessieren sind schicken möchten, benutzen Sie bitte unser Formular.
               </p>
            </div>
         </div>
      </header>
            ...
            <?php
               ...
               if ($action=="")
                   ...
                   <select class="product-select" name="nazwa-produktu">
                      ...
                      <option value="Schrumpffolien">Schrumpffolien</option>
                      <option value="Warnbänder">Warnbänder</option>
                   </select>
                   ...
                   <h3>Dimensionen:</h3>
                     ...
                     <select class="product-select" name="ilosc">
                        <option value="">---</option>
                        <option value="metry kwadratowe">kwadrat Meter</option>
                        <option value="w rolce">auf der Rolle</option>
                     </select>
                     <input type="text" name="ilosc-liczba" value="" placeholder="menge">
                     ...
                     <input type="text" name="ilosc-box" value="" placeholder="menge auf der pallete">
